...
// Filename:    TradeMogul Timed Product (Days)
// Version:     0.1
// Date:        08.31.2010
...
// Allows a product to disappear after a certain amount of time (in days.) This is to simulate consumption or decay, such as spoilage of overstocked items. Once rezzed or attached, the prims have a lifespan of X days (set in object description) This uses a UNIX timestamp, in effect even if taken back into inventory. If rezzed again after the expiration, the prim will simply disappear. 
...
default
{
    ...
    on_rez(integer start_param)
    {
        ...
        TIMEOUT = (integer)llGetObjectDesc() * 1440;
